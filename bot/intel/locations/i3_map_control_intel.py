...
def derive_map_control_intel(
    ...
    *,
    ...
    hold_pos = sanitize_natural_defense_point(
        bot,
        pos=nat.towards(enemy_main, 4.5),
        fallback=nat,
        prefer_towards=nat.towards(enemy_main, 6.0),
        nat=nat,
    )
    staging_pos = sanitize_natural_defense_point(
        bot,
        pos=nat.towards(bot.start_location, 3.0),
        fallback=nat,
        prefer_towards=nat,
        nat=nat,
    )
