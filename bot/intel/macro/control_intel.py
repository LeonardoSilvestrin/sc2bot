...
class SpendingIntel:
    ...
    def step(
        ...
        *,
        ...
        a = float(self.flow_alpha)
        m_income_ema = (1.0 - a) * prev_m_income_ema + (a * m_income)
        m_spend_ema = (1.0 - a) * prev_m_spend_ema + (a * m_spend)
        g_income_ema = (1.0 - a) * prev_g_income_ema + (a * g_income)
        g_spend_ema = (1.0 - a) * prev_g_spend_ema + (a * g_spend)
