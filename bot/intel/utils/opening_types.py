...
class OpeningIntelConfig:
    ...
    rush_score_suspected: float = 68.0
    rush_score_confirmed: float = 92.0
    rush_score_medium: float = 80.0
    rush_score_heavy: float = 108.0
    rush_score_extreme: float = 136.0
    rush_heavy_near_bases: int = 3
    rush_extreme_near_bases: int = 5
    rush_end_clear_s: float = 28.0
    rush_hold_max_s: float = 55.0
    log_interval_s: float = 8.0
    rush_suspect_decay_s: float = 28.0
    rush_confirmed_min_hold_s: float = 45.0
    ...
    one_base_alert_at_s: float = 120.0
