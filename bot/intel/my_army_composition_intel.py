...
from bot.intel.army_comp_intel import ArmyCompIntelConfig, derive_army_comp_intel
from bot.intel.macro_mode_intel import MacroModeIntelConfig, derive_macro_mode_intel
from bot.intel.tech_intel import TechIntelConfig, derive_tech_intel
