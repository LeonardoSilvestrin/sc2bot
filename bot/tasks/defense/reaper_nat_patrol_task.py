...
_REAPER_ATTACK_RANGE = 5.5
_DEFAULT_ENGAGE_RADIUS = 12.0
...
class ReaperPatrolTask(BaseTask):
    ...
    async def on_step(self, bot, tick: TaskTick, attention: Attention) -> TaskResult:
        ...
        if issued > 0:
            self._active(self.task_id)
            return TaskResult.running(self.task_id)
        return TaskResult.noop(f"{self.task_id}_idle")
