...
from bot.builds.banshee_hellion_open import STAGED_PROFILES_BY_PHASE as BANSHEE_HELLION_OPEN_STAGED_BY_PHASE
...
STAGED_PROFILES_BY_OPENING: Dict[str, Dict[str, Dict[str, Any]]] = {
    "BansheeHellionOpen": BANSHEE_HELLION_OPEN_STAGED_BY_PHASE
}
