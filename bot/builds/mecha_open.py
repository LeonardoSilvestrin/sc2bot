...
def _mecha_phase(*, phase: str) -> Dict[str, Any]:
    ...
    if p == "OPENING":
        return {
            ...
            "comp": {"HELLION": 0.26, "CYCLONE": 0.10, "SIEGETANK": 0.28, "BANSHEE": 0.2, "WIDOWMINE": 0.16},
            "priority": ["SIEGETANK", "WIDOWMINE", "HELLION", "CYCLONE", "BANSHEE"],
            ...
            "unit_count_milestones": [{"t": 90.0, "units": {"HELLION": 2}}, {"t": 150.0, "units": {"HELLION": 4, "WIDOWMINE": 1, "SIEGETANK": 1}}, {"t": 210.0, "units": {"HELLION": 6, "WIDOWMINE": 2, "SIEGETANK": 2, "CYCLONE": 1}}],
            "timing_attacks": [],
    ...
    if p == "LATEGAME":
        return {
            ...
            "comp": {"HELLION": 0.24, "CYCLONE": 0.28, "SIEGETANK": 0.24, "BANSHEE": 0.18, "WIDOWMINE": 0.06},
            "priority": ["CYCLONE", "HELLION", "SIEGETANK", "WIDOWMINE", "BANSHEE"],
    ...
    return {
        ...
        "comp": {"HELLION": 0.30, "CYCLONE": 0.24, "SIEGETANK": 0.26, "BANSHEE": 0.16, "WIDOWMINE": 0.04},
        "priority": ["CYCLONE", "HELLION", "SIEGETANK", "WIDOWMINE", "BANSHEE"],
        ...
        "unit_count_milestones": [{"t": 210.0, "units": {"HELLION": 6, "SIEGETANK": 2, "CYCLONE": 2, "BANSHEE": 1}}, {"t": 300.0, "units": {"HELLION": 8, "SIEGETANK": 4, "CYCLONE": 4, "BANSHEE": 2}}],
