...
from . import addons, army, expansion, gas, production, supply, worker
...
class MacroPlanner:
    ...
    *affordable* -- it declares useful goals and their costs; the economy
    ...
    def propose(
        ...
        supply_proposal = supply.propose_supply(
            self.config,
            self.planner_id,
            economy,
            world.supply_used,
