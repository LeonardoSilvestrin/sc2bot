...
from bot.behavior.harass.reaper import ReaperHarassExecutor
...
class ReaperHarassExecutorTests(unittest.IsolatedAsyncioTestCase):
    async def test_attack_moves_the_harasser_toward_the_target_while_active(self):
        commands = FakeCommands()
        executor = ReaperHarassExecutor(
